...
try:
    from refactoring_workspace.new_architecture.services.core_routes import *
except ImportError:
    # Fallback si module non trouv
    pass

try:
    from refactoring_workspace.new_architecture.routers.core_routes import *
except ImportError:
    pass

try:
    from refactoring_workspace.new_architecture.dependencies.core_routes import *
except ImportError:
    pass
...
class TestCoreRoutes:
    """
     Classe de tests pour core_routes
    Coverage cible: 90.0%
    """
    
    @pytest.fixture
    def mock_dependencies(self):
        """[TOOL] Mock des dpendances pour core_routes"""
        mocks = {}
                mocks["services"] = Mock()
    ...
    @pytest.mark.asyncio
    async def test_core_routes_endpoints_status(self, mock_dependencies):
        """
         Test status codes endpoints core_routes
    ...
    @pytest.mark.asyncio
    async def test_core_routes_request_validation(self, mock_dependencies):
        """
         Test validation requests core_routes
        Type: Test d'intgration
        """
        # Arrange
                # Configuration test
    ...
    @pytest.mark.asyncio
    async def test_core_routes_response_format(self, mock_dependencies):
        """
         Test format responses core_routes
        Type: Test d'intgration
        """
        # Arrange
                # Configuration test
    ...
    def test_core_routes_performance_load(self):
        """
         Test charge core_routes
        Type: performance
        """
...
class TestPerformanceCoreRoutes:
    """
    [LIGHTNING] Tests de performance pour core_routes
