#!/usr/bin/env python3
"""
🔧 SCRIPT D'INTÉGRATION LOGGING - AGENT_15_TESTEUR_SPECIALISE
...
class Agent15TesteurspecialiseLoggingIntegration:
    """
    Intégration logging pour agent_15_testeur_specialise
    """
    
    def __init__(self, agent_instance):
        self.agent = agent_instance
        self.logger = LoggingManager().get_agent_logger('agent_15_testeur_specialise')
        
        # Configuration spécialisée
        self.reports_dir = Path(__file__).parent / "reports_equipe_agents" / "agent_15_testeur_specialise"
...
def integrate_logging(agent_instance):
    ...
    """
    return Agent15TesteurspecialiseLoggingIntegration(agent_instance)

# Test d'intégration
if __name__ == "__main__":
    print(f"🔧 Test intégration logging pour agent_15_testeur_specialise")
    
    # Simulation d'agent
    class MockAgent:
        def __init__(self):
            self.name = "agent_15_testeur_specialise"
