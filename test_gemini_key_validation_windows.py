...
# -*- coding: utf-8 -*-
"""
Script de Validation des Clés API Gemini - Version Windows
...
try:
    ...
    # Si python-dotenv n'est pas installé, on essaie de charger manuellement
...
def test_gemini_connection(api_key: str) -> Tuple[bool, str, List[str]]:
    """Test de connexion avec une clé API Gemini."""
    try:
        import google.generativeai as genai
...
def test_gemini_generation(api_key: str) -> Tuple[bool, str]:
    """Test de génération de contenu avec Gemini."""
    try:
        import google.generativeai as genai
        
        genai.configure(api_key=api_key)
        
        # Test avec le modèle le plus rapide
