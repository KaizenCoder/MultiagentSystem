...
class ValidationEngine:
    ...
    def __init__(self, agent_id: str):
        ...
        self.logger = logging_manager.get_logger("validation_engine")
        self.reality_checks = []
        self.evidence_trail = []
...
class DependencyResolver:
    """Résolveur de dépendances entre tâches"""
    
    def __init__(self):
        self.logger = logging_manager.get_logger("dependency_resolver")
        self.dependency_graph = defaultdict(set)
    
    def analyze_dependencies(self, task_definition: TaskDefinition) -> Dict[str, Any]:
        """Analyse les dépendances d'une tâche"""
        dependencies = {
            "required_agents": [],
            "required_resources": [],
            "prerequisite_tasks": [],
...
class TaskMasterAI:
    ...
    def __init__(self, agent_id: str, config: Dict[str, Any]):
        self.agent_id = agent_id
        self.config = config
        self.logger = logging_manager.get_logger("taskmaster_ai")
        
        # Composants IA
        self.nlp_processor = NLPProcessor()
        self.validation_engine = ValidationEngine(agent_id)
