    ...
    def __init__(self, agent_type: str = "auditeur_performance", **config):
        ...
        try:
            ...
            self.logger = logging_manager.get_logger(
                config_name="audit",
                custom_config={
                    "logger_name": f"nextgen.audit.19_auditeur_performance.{self.agent_id if hasattr(self, 'agent_id') else self.id if hasattr(self, 'id') else 'unknown'}",
                    "log_dir": "logs/audit",
                    "metadata": {
                        "agent_type": "19_auditeur_performance",
                        "agent_role": "audit",
