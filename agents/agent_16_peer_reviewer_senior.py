    ...
    class Agent:
        ...
        try:
            ...
            self.logger = logging_manager.get_logger(
                config_name="general",
                custom_config={
                    "logger_name": f"nextgen.general.16_peer_reviewer_senior.{self.agent_id if hasattr(self, 'agent_id') else self.id if hasattr(self, 'id') else 'unknown'}",
                    "log_dir": "logs/general",
                    "metadata": {
                        "agent_type": "16_peer_reviewer_senior",
                        "agent_role": "general",
...
class PeerReviewerSeniorAgent(Agent):
    ...
    def run_senior_review_mission(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.info("🏆 MISSION REVIEW SENIOR ACCOMPLIE - VALIDATION ARCHITECTURE EXPERTE")
            ...
            self.logger.error(f"❌ Erreur mission review senior : {e}", exc_info=True)
            return {
    ...
    def _review_architecture_globale(self) -> Dict[str, Any]:
        ...
        self.logger.info("🏗️ ÉTAPE 1 : Review architecture globale...")
        ...
        try:
            ...
            self.logger.error(f"Erreur review architecture : {e}", exc_info=True)
        
        return architecture_review
    
    def _validate_expert_conformity(self) -> Dict[str, Any]:
        """Validation conformité aux plans experts"""
        self.logger.info("📋 ÉTAPE 2 : Validation conformité plans experts...")
        ...
        try:
            ...
            self.logger.error(f"Erreur validation conformité : {e}", exc_info=True)
    ...
    def _review_technical_quality(self) -> Dict[str, Any]:
        ...
        self.logger.info("🔍 ÉTAPE 3 : Review qualité technique...")
    ...
    def _validate_best_practices(self) -> Dict[str, Any]:
        ...
        self.logger.info("📏 ÉTAPE 4 : Validation best practices...")
    ...
    def _generate_strategic_recommendations(self) -> Dict[str, Any]:
        ...
        self.logger.info("🎯 ÉTAPE 5 : Recommandations stratégiques...")
    ...
    def _generate_senior_report(self, arch_review, conf_review, qual_review, pract_review, strat_rec) -> str:
        ...
        self.logger.info("📄 ÉTAPE 6 : Génération rapport senior...")
...
"""
        ...
        try:
            ...
            self.logger.info(f"✅ Rapport senior généré : {report_path}")
        except Exception as e:
