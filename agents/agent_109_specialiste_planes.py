    ...
    class AgentFactoryConfig:
        ...
        try:
            ...
            self.logger = logging_manager.get_logger(
                config_name="general",
                custom_config={
                    "logger_name": f"nextgen.general.109_specialiste_planes.{self.agent_id if hasattr(self, 'agent_id') else self.id if hasattr(self, 'id') else 'unknown'}",
                    "log_dir": "logs/general",
                    "metadata": {
                        "agent_type": "109_specialiste_planes",
                        "agent_role": "general",
