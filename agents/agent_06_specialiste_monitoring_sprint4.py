    ...
    def __init__(self, agent_id="agent_06_specialiste_monitoring", agent_type="monitoring", version="0.1.0-sprint4", **kwargs):
        ...
        try:
            ...
            self.logger = logging_manager.get_logger(
                config_name="general",
                custom_config={
                    "logger_name": f"nextgen.general.06_specialiste_monitoring_sprint4.{self.agent_id if hasattr(self, 'agent_id') else self.id if hasattr(self, 'id') else 'unknown'}",
                    "log_dir": "logs/general",
                    "metadata": {
                        "agent_type": "06_specialiste_monitoring_sprint4",
                        "agent_role": "general",
