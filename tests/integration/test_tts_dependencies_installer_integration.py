#!/usr/bin/env python3
"""
Tests d'Intgration - TTS Dependencies Installer
"""
...
class TestTTSDependenciesInstallerIntegration(unittest.TestCase):
    """Tests d'intgration pour tts_dependencies_installer"""
    
    def setUp(self):
        """Configuration des tests"""
        self.tool_path = Path(__file__).parent.parent / "tools" / "tts_dependencies_installer"
        self.script_principal = self.tool_path / "tts_dependencies_installer.py"
